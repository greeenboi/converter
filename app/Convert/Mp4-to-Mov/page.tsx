  ...
  const transcode = async () => {
    ...
    if (inputFileRef.current?.files?.length) {
      ...
      reader.onload = async function(e) {
        ...
        const outputData = (await ffmpeg.readFile('output.mov')) as any
        if (videoRef.current)
          videoRef.current.src = URL.createObjectURL(new Blob([outputData.buffer], { type: 'video/quicktime' }))
      }
