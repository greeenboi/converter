...
export default function Page(){
    ...
    return(
        <main className="z-20 absolute text-black flex flex-col items-center justify-center w-screen gap-2 overflow-hidden">
            <section className="w-full my-12 md:my-16 lg:my-24 md:w-10/12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12 lg:gap-14">
